...
const ProductModal = ({modalData, setModalData, showProductModal, setShowProductModal}) => {
  ...
  return (
    <div className={`fixed top-20 lg:top-15 left-0 w-screen h-5/6 bg-inherit z-[1200] py-7 md:py-10 overflow-y-scroll transition-all duration-300 ${showProductModal?'visible opacity-100':'invisible opacity-0' }`} onClick={HideModal}>
        <div className='w-[90vw] lg:w-[78vw] bg-slate-100 min-h-[80vh] shadow rounded-md p-5 mx-auto flex flex-col relative'>
